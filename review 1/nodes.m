...
text(relay5(1), relay5(2) - 0.05, 'relay 5', 'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', 'FontSize', 8);
...
plot([relay5(1),destination(1)],[relay5(2),destination(2)],'y-', 'LineWidth', 1);
...
plot([relay5(1),source(1)],[relay5(2),source(2)],'y-', 'LineWidth', 1);
...
plot([relay5(1),eavedropper(1)],[relay5(2),eavedropper(2)],'r--', 'LineWidth', 1);
